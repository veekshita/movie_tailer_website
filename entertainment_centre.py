...
ZMND = media.Movie("Zindagi na milegi dubbara", "A story on Life",
                   "Rating:9/10",
...
Twilight = media.Movie("The twilight saga", "love story between vampire and a human",
                        "Rating:7/10",
...
threeidiots = media.Movie("3 idiots", "Life of engineers",
                      "Rating:9/10",
